...
import barecomputer.MyLock;
import devicemanage.PcbBlock;
...
public class DeviceGUI extends Thread
{
	...
	private void initialize() 
	{
		...
		closeButton.setFont(new Font("楷体", Font.BOLD, 48));
		...
		lblNewLabel_8_3.setFont(new Font("仿宋", Font.BOLD, 24));
		...
		lblNewLabel_9_2.setFont(new Font("仿宋", Font.BOLD, 24));
		panel.add(lblNewLabel_9_2, "cell 0 4");
		
		JLabel lblNewLabel_10_3 = new JLabel("PrinterB");
		lblNewLabel_10_3.setFont(new Font("仿宋", Font.BOLD, 18));
		...
		lblNewLabel_8_4.setFont(new Font("仿宋", Font.BOLD, 24));
		...
		lblNewLabel_9_3.setFont(new Font("仿宋", Font.BOLD, 24));
		panel.add(lblNewLabel_9_3, "cell 0 5");
		
		JLabel lblNewLabel_10_4 = new JLabel("PrinterC");
		lblNewLabel_10_4.setFont(new Font("仿宋", Font.BOLD, 18));
		...
		lblNewLabel_8_5.setFont(new Font("仿宋", Font.BOLD, 24));
		...
		lblNewLabel_9_4.setFont(new Font("仿宋", Font.BOLD, 24));
		panel.add(lblNewLabel_9_4, "cell 0 6");
		
		JLabel lblNewLabel_10_5 = new JLabel("Lenovo");
		lblNewLabel_10_5.setFont(new Font("仿宋", Font.BOLD, 18));
		...
		cameraLast.setFont(new Font("仿宋", Font.PLAIN, 24));
		...
		printerLast.setFont(new Font("仿宋", Font.PLAIN, 24));
		...
		outputBar.setFont(new Font("宋体", Font.PLAIN, 24));
		...
		outputLast.setFont(new Font("仿宋", Font.PLAIN, 24));
		...
		inputBar.setFont(new Font("宋体", Font.PLAIN, 24));
		...
		inputLast.setFont(new Font("仿宋", Font.PLAIN, 24));
		...
		fileLast.setFont(new Font("仿宋", Font.PLAIN, 24));
	...
	public void flashBlockInfo()
	{
		...
		inputLast.setText("剩余资源:\n\t"+last+"\n总资源数:\n\t1");
		use = (time*100) / clock;
		inputBar.setValue(use);
		inputBar.setString(use+"%");
		inputBar.setToolTipText("有效工作时间: "+time);
		inputText.setText("");
		if(last!=1)
		{
