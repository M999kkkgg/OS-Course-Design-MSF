...
public class ProcessGUI extends Thread
{
	...
	private void initialize()
	{
		...
		closeButton.setFont(new Font("楷体", Font.PLAIN, 24));
		...
		pageText.setFont(new Font("仿宋", Font.PLAIN, 14));
		...
		codeText.setFont(new Font("仿宋", Font.PLAIN, 16));
		...
		buttun1.setFont(new Font("楷体", Font.PLAIN, 18));
		...
		buttun2.setFont(new Font("楷体", Font.PLAIN, 18));
		...
		buttun3.setFont(new Font("楷体", Font.PLAIN, 18));
		...
		buttun4.setFont(new Font("楷体", Font.PLAIN, 18));
		...
		buttun5.setFont(new Font("楷体", Font.PLAIN, 18));
		...
		buttun6.setFont(new Font("楷体", Font.PLAIN, 18));
		...
		buttun7.setFont(new Font("楷体", Font.PLAIN, 18));
		...
		buttun8.setFont(new Font("楷体", Font.PLAIN, 18));
		...
		buttun9.setFont(new Font("楷体", Font.PLAIN, 18));
		...
		buttun10.setFont(new Font("楷体", Font.PLAIN, 18));
		...
		buttun11.setFont(new Font("楷体", Font.PLAIN, 18));
		...
		buttun12.setFont(new Font("楷体", Font.PLAIN, 18));
		...
		deadText.setFont(new Font("仿宋", Font.PLAIN, 14));
		...
		blockText.setFont(new Font("仿宋", Font.PLAIN, 14));
		...
		runText.setFont(new Font("仿宋", Font.PLAIN, 14));
		...
		readyText.setFont(new Font("仿宋", Font.PLAIN, 14));
		...
		newText.setFont(new Font("仿宋", Font.PLAIN, 14));
	...
	public void showCode(int index)
	{
		...
		{
			codeText.append("进程号: "+Computer.memory.pcbPool.pool[index].getProcessNumber()+"\n");
			codeText.append("进程名: "+Computer.memory.pcbPool.pool[index].getProcessName()+"\n");
			codeText.append("代码数: "+Computer.memory.pcbPool.pool[index].getCodeLength()+"\n");
			codeText.append("代码段:\n");
		...
		{
			codeText.setText("该固定分配位置上没有调入进程");
		}
	}
	public void showPageTable(int index)
	{
		...
		if(Computer.memory.pcbPool.poolMap[index])
		{
			pageText.append("进程号: "+Computer.memory.pcbPool.pool[index].getProcessNumber()+"\n");
			pageText.append("进程名: "+Computer.memory.pcbPool.pool[index].getProcessName()+"\n");
			pageText.append("页表:\n");
		...
		{
			pageText.setText("该固定分配位置上没有调入进程");
		}
	}
}
